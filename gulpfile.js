...
gulp.task('index', function () {
    ...
    var sourcesIndex = gulp.src([
        ...
        './public/js/config/app.js', './public/js/factories/**/*.js', './public/js/services/**/*.js', './public/js/controllers/**/*.js', './public/js/filters/**/*.js', './public/js/directives/**/*.js', './bower_components/**/*.css', './public/css/**/*.css'], { read: false });


    return target
        //.pipe(inject(sources))
        .pipe(inject(gulp.src('./bower_components/angular/angular.min.js', { read: false }), { name: 'angular.min.js' }))
        .pipe(inject(sourcesIndex, { name: 'rest-modules' }))
        .pipe(gulp.dest('./dev'))
});
...
gulp.task('index:dist', function () {
    ...
    var sourcesDist = gulp.src(['./bower_components/**/!(angular.min)*.js', './public/js/min/all.min.js', './bower_components/**/*.css', './public/css/**/*.css'], { read: false });

    return target
        .pipe(inject(gulp.src('./bower_components/angular/angular.min.js', { read: false }), { name: 'angular.min.js' }))
        .pipe(inject(sourcesDist, { name: 'rest-modules' }))
        .pipe(gulp.dest('./dist'))
});
